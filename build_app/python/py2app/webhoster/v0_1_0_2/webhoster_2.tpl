...
<body>
    <h1>My Hosting Tool ( page2 )</h1>
    <p>Jack's image:</p>
    <p>Before build</p>
    <br>
    <img src="/static/image.png" height="500" width="700" border="3"> <!-- 실제 이미지의 패스와 상관 없이 "/static/image_1.png"로 항상 고정 -->
    <br><br>
    ...
    <br><br>
    <a href="/static/html_file.html">sub_page_1</a>
