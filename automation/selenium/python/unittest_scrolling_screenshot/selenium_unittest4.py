	...
	def test_testcase(self):
		...
		while m < len(base_url):
			...
			while n < len(key_word_list):
				...
				print("[ DEBUG ] line " + str(cf.f_lineno)+" ==> browser_type_type :",type(browser_url))
				print("[ DEBUG ] line " + str(cf.f_lineno)+" ==> browser_type :",browser_url)

				driver.get(browser_url)
				browser_type = browser_url.replace("https://www.", "")
				print("[ DEBUG ] line " + str(cf.f_lineno)+" ==> browser_type_type :",type(browser_type))
				print("[ DEBUG ] line " + str(cf.f_lineno)+" ==> browser_type :",browser_type)
				...
				while True:
					...
					print("[ DEBUG ] line " + str(cf.f_lineno)+" ==> last_height :",last_height)
					if Y > last_height: # new_height == last_height:
					# if new_height == last_height:
						break
						# print("[ DEBUG ] line " + str(cf.f_lineno))
