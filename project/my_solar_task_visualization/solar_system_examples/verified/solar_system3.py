# -*- coding: utf-8 -*-
# https://rishicodes.wordpress.com/2015/07/11/making-a-solar-system-using-python/
...
class SolarSystem:
    def __init__(self, width, height):
        ...
        self.ssscreen.setworldcoordinates(-width/1.0,-height/1.0,width/1.0,height/1.0)
        # self.ssscreen.tracer(50) ### 도는 속도
        self.ssscreen.tracer(50) ### 도는 속도
...
class Sun:
   ...
   def getVolume(self):
       ...
       v = 40.0/3 * math.pi * self.radius**3
       return v

   def getSurfaceArea(self):
       # sa = 4.0 * math.pi * self.radius**2
       sa = 40.0 * math.pi * self.radius**2
       return sa
...
def createSSandAnimate():
   ...
   m = Planet("EARTH", 47.5, 50000, 0.3, 0, 2.0, "green")
   ss.addPlanet(m)
   ...
   numTimePeriods = 360000000000 # 20000
