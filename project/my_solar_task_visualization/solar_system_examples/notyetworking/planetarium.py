...
##				self.model = loader.loadModelCopy("models/fighter")			
##				#self.model.reparentTo(player.node)
##				self.texture = loader.loadTexture("models/texturemap.png")
...
class Universe(DirectObject):
	...
	def move(self,task):
		dt = self.dt
		self.player.node.setPos(base.camera.node)
