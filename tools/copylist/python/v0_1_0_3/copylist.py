...
lb6 = Label(frame5, text="Copylist 5", bg="mistyrose", font=("Helvetica 14"))
...
frame5.grid(); lb6.grid(row=0, sticky=W)
...
b6 = Button(frame5, text="Update", command=lambda:[cmbbx_update()])
...
frame5.grid(); b5.grid(row=2, sticky=W)
frame5.grid(); b6.grid(row=2, sticky=E)
