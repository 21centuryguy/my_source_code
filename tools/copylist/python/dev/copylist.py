...
# - func 5
def edit_item_list5():
    clipboard_history_file_path = "/Users/jack/Documents/GitHub/local/tools/clipboard/python/pyperclip/clipboard_saver/clipboard_history.txt"
    # copy_list5_file_path ="open copy_list5.txt" 
...
def cmbbx_update():
    ...
    # cb = ttk.Combobox(frame, textvariable=cb_val5, height=10, width=43)
    cb['values'] = items
    frame.grid()
    cb.grid(row=1)
...
def cmbbx_update2():
    ...
    # cb2 = ttk.Combobox(frame2, textvariable=cb_val2, height=10, width=43)
    cb2['values'] = items2
    frame2.grid()
    cb2.grid(row=1)
...
def cmbbx_update3():
    ...
    cb_val3.set("Snippet")
    # cb3 = ttk.Combobox(frame3, textvariable=cb_val3, height=10, width=43)
    cb3['values'] = items3
    frame3.grid()
    cb3.grid(row=1)
...
def cmbbx_update4():
    ...
    # cb4 = ttk.Combobox(frame4, textvariable=cb_val4, height=10, width=43)
    cb4['values'] = items4
    frame4.grid()
    cb4.grid(row=1)
...
def cmbbx_update5():
    ...
    # cb5 = ttk.Combobox(frame5, textvariable=cb_val5, height=10, width=43)
    cb5['values'] = items5
    frame5.grid()
    cb5.grid(row=1)
...
cb_val = StringVar()
cb_val.set("Copyitmes with linebreak")
cb = ttk.Combobox(frame, textvariable=cb_val, height=10, width=43)
cb['values'] = items
frame.grid()
cb.grid(row=1)
...
b5 = Button(frame5, text="Edit", command=lambda:[edit_item_list5()]); b10 = Button(frame5, text="Update", command=lambda:[cmbbx_update5()])
...
frame5.grid(); b5.grid(row=2, sticky=W); frame5.grid(); b10.grid(row=2, sticky=E)
