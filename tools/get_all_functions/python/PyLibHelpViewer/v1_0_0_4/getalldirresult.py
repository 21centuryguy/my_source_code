...
import sys
import shutil
import selenium.webdriver.common.html5; target ="selenium.webdriver.common.html5"
...
def help_target(target):
	...
	x = dir(selenium.webdriver.common.html5)
	# print(x)
	...
	with open("result/result.txt", "w") as archi:
		t = sys.stdout
		sys.stdout = archi
		help(selenium.webdriver.common.html5)
		sys.stdout = t
