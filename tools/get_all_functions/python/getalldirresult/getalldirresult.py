...
try:
	import selenium.webdriver.chrome.webdriver; target ="selenium.webdriver.chrome.webdriver"
...
def help_target(target):
	...
	x = dir(selenium.webdriver.chrome.webdriver)
	# print(x)
	...
	with open("result/result.txt", "w") as archi:
		t = sys.stdout
		sys.stdout = archi
		help(selenium.webdriver.chrome.webdriver)
		sys.stdout = t
