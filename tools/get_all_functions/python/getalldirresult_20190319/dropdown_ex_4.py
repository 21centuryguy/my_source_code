...
# ---
def call_mode1():
	check_output("python /Users/jack/Documents/GitHub/local/tools/get_all_functions/python/getalldirresult/getalldirresult.py --mode 1", shell=True)

def call_mode2():
	check_output("python /Users/jack/Documents/GitHub/local/tools/get_all_functions/python/getalldirresult/getalldirresult.py --mode 2", shell=True)
# ---
