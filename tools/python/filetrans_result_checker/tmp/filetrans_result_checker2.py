...
class Ftrans_checker():
	...
	def file_cooker(self):
		...
		root = Tkinter.Tk()
		root.withdraw()
		input_dirname = tkFileDialog.askdirectory(parent=root,initialdir="/",title='Please select a directory') 
		print input_dirname

		########################################################################
		####  getting number of files in folder and file name list
		list = os.listdir(input_dirname)
		...
		####  show and save the result after deleting target language character
			...
			file_full_path = input_dirname + '//'+ list[m]
		...
		########################################################################
		#### save deleting result
		root2 = Tkinter.Tk()
		root2.withdraw()
		output_dirname = tkFileDialog.askdirectory(parent=root2,initialdir="/",title='Please select a directory') 
		print output_dirname

		if target_lang == 1:
			result_file_path = output_dirname + '//trans_check_jaen.txt'
		if target_lang == 2:
			result_file_path = output_dirname + '//trans_check_enja.txt'			
